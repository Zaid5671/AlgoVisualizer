...
<a className="px-3 py-1.5 hover:bg-surface-container-high border border-transparent hover:border-primary transition-all uppercase" href="#pedagogy">Docs</a>
</nav>
</div>
